...
<header>
    ...
    <main class="main-wrapper">
        ...
        <?php
            $tensach = !empty($_GET['tensach']) ? urldecode($_GET['tensach']) : '';
            ...
            if ($tensach) {
                ...
                if ($sach) { // Kiểm tra xem $sach có khác null không
                    ...
                    if ($sach->soluong == 0) {
                        ...
                        if(empty($_SESSION["makh"])){   
                            echo "<button class='btn' id='addtocart-login'>Thêm vào giỏ hàng</button>"; 
                        }
                        else{
                    ...
                    if(empty($_SESSION["makh"])){   
                        echo "<button class='btn' id='danhgia-login'>Đánh giá sách</button>";
                    }
                    else{
                ...
                echo '</div><h1 style="text-align: center;"> Không có sách tên '.$tensach.' </h1><div>';
            }
        }
        ?>
        </div>
        <div>
            ...
            if (is_array($reviews) || is_object($reviews)) {
                ...
                echo "<p style='text-align: center;'>Chưa có đánh giá nào cho sách này.</p>";
            }
    ?>
    </div>
    <?php
