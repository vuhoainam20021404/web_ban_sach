...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($enteredCode == $_SESSION['verification_code']) {
            // Mã xác minh đúng, chuyển hướng đến trang thay đổi mật khẩu
            header("Location: doimatkhau.php?cid=true");
        } else {
            echo "<script>alert('Mã xác minh không đúng!');</script>";
        }
    }
...
<header>
    ...
    <main class="main-wrapper">
        <div>
            ...
            <form action="nhapmaxacminh.php" method="POST">
