...
let cartbtn = document.getElementById('cart-login');
let addtocartbtn = document.getElementById('addtocart-login');
let danhgiasachbtn = document.getElementById('danhgia-login');
...
danhgiasachbtn.addEventListener('click', () => {
    document.querySelector('.form-message-check-login').innerHTML = '';
    formsg.classList.add('open');
    container.classList.add('active');
    body.style.overflow = "hidden";
...
document.addEventListener("DOMContentLoaded", function () {
    // Đoạn mã JavaScript liên quan đến slider
    ...
    setInterval(nextSlide, 4000); // Chuyển đổi slide sau mỗi 4 giây
