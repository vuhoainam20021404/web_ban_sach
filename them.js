...
document.getElementById('add-product-btn').addEventListener('click', function() {
    ...
    newProductItem.innerHTML = `
        <label>Mã Sách</label>
        <input type="text" name="mas[]" placeholder="Nhập mã sách" required>
...
document.getElementById('add-donhang_nhap-btn').addEventListener('click', function() {
    // Lấy phần tử container sản phẩm
    const container = document.getElementById('donhang_nhap-container');
