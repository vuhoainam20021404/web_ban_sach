...
<header>
                    ...
                    <?php foreach ($cart as $item): ?>
                        <div class="product_cart">  
                            ...
                            <div class="product-detail">
                                ...
                                <p>Giá: <?php echo number_format($item['giaban']); ?> VNĐ</p>
                                <p>Số lượng: <span class="quantity-text"><?php echo htmlspecialchars($item['soluong']); ?></span></p>
                                <p>Tổng: <span class="item-total"><?php echo number_format($item['giaban'] * $item['soluong']); ?> VNĐ</span></p> <!-- Display total price for the item -->
                            </div>
                            <div>
    ...
    if(isset($_SESSION['makh'])){
        ...
        echo "</div><p style='text-align: center;'>Bạn chưa đăng nhập!.</p>";
    }
    ...
    if($tensach){
        ...
        foreach ($tensach as $index => $name) {
            $tong += $soluong[$index] * $giaban[$index];
        }
        ...
        if ($vnp_Amount !== null) {
            ...
            foreach ($ds_masach as $index => $masach) {
                ...
                if ($sach = $sachList[0]) {
                    ...
                    $giaban = $sach->giaban; // Lấy giá bán của sách
                    $soluong = $ds_soluong[$index];
    ...
    <?php
        ...
        echo "</div><p style='text-align: center;'>Bạn chưa chọn sách trong giỏ hàng để thanh toán!.</p>";
    }
    ?>
    </div>
