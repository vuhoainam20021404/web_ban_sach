...
$action = $cid == 'true' ? '2' : '1'; // Nếu cid=true, action sẽ là 2, nếu không thì action là 1

// Khi form được gửi, xử lý hành động dựa trên giá trị `action`
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $passnew = $_POST["passnew"] ?? ''; // Mật khẩu mới từ form
    $ac = $_POST["action"] ?? ''; // Mật khẩu mới từ form
    if ($ac == '1') {
        // Chức năng thay đổi mật khẩu thông thường
        Taikhoan::EditPASS($passnew, $_SESSION["makh"]);
        header("Location: giaodienkh.php");
    } else if ($ac == '2') {
        // Chức năng đặt lại mật khẩu khi quên
        Taikhoan::Quenmatkhau($passnew, $_SESSION['reset_email']);
        header("Location: giaodienkh.php");
    }
}
...
<header>
            ...
            <div class="container">
                ...
                <div class="header-middle-right">
                    <ul class="header-middle-right-list">
                        ...
                        <li class="header-middle-right-item dropdown open">
                            ...
                            <ul class="header-middle-right-menu">
                                ...
                                <?php } else { ?>
                                    ...
                                    <li><a href="dangxuat.php"><i class="fa-light fa-sign-out-alt"></i> Đăng xuất</a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <?php
                        ...
                        ?>                                    
                            <li id="cart-login" class="header-middle-right-item open">
                            <div class="cart-icon-menu">
                    ...
                    <?php foreach ($cart as $item):
                        ...
                        <div class="product_cart">  
                            ...
                            <div class="product-detail">
                                ...
                                <p>Số lượng: <span class="quantity-text"><?php echo htmlspecialchars($item['soluong']); ?></span></p>
                            ...
                            <button type="button" class=" select-button" onclick="selectItem(this, <?php echo htmlspecialchars($item['giaban']); ?>)">x</button>
                            </div>                       
                        </div>
                        <?php endforeach; 
                    }
    ...
    <script src="./js/main.jsv=<?php echo time() ?>"></script>
